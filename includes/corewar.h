...
void			cursor_list_del(t_cursor **orig, t_cursor **list, t_cursor *prev);
...
int				do_check(t_cursor **cursor_list, int *cycles_to_die, t_game_info *info);
...
int				cmd_live(unsigned char *mem, t_cursor *cursor, t_game_info *game_info);
int				cmd_zjmp(unsigned char *mem, t_cursor *cursor);
int				cmd_fork(unsigned char *mem, t_cursor *cursor, t_game_info *game_info);
int				cmd_lfork(unsigned char *mem, t_cursor *cursor, t_game_info *game_info);
...
void				cmd_st(unsigned char *mem, t_cursor *cursor, t_cmd_info *cmd_info,
				t_game_info *game_info);
...
void				cmd_sti(unsigned char *mem, t_cursor *cursor, t_cmd_info *cmd_info,
				t_game_info *game_info);
void				cmd_lldi(unsigned char *mem, t_cursor *cursor, t_cmd_info *cmd_info);
void				cmd_aff(unsigned char *mem, t_cursor *cursor, t_game_info *game_info);
